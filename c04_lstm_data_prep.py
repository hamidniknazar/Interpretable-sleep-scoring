...
# torch.save({'train_files':train_files,'train_labels':train_labels,'val_files':val_files,'val_labels':val_labels,'test_subjects':test_subjects},'Names_labels.hamid')
...
for i in range(int(n_iter)):
    ...
    data,label=making_batch(names=train_files,labels=train_labels,prob=None,n_batch=test_minibach_size,ite=i)
...
torch.save({'OUT':OUT,'train_labels':train_labels,'train_files':train_files},'Data_for_LSTM.data')
